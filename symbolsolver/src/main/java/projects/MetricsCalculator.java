...
public class MetricsCalculator {
    ...
    public List<ProjectMetrics> calculateMetrics(List<Project> projects) throws IOException {
        ...
        for (Project project : projects) {
            ...
            System.out.println("AHMED: " + parseResultServices.toString());
            ...
            System.out.println("Serv: " + services.toString());
             
            System.out.println("INTERFACE7pm: " + pm.toString());
    ...
    public void writeToFile(ProjectMetrics metrics) throws IOException {
        ...
        // WRITE TO PROJECT SPECIFIC FILE CHANGE
