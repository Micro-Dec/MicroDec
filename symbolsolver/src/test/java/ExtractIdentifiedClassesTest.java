...
public class ExtractIdentifiedClassesTest {
    ...
    public void parseAndExtractBulk() throws IOException {
        ...
        String path = "/Users/ahmedalsayed/Documents/word2vec/data/interfaces/projects.csv";
        // Get all the repos
    ...
    public void parseAndExtract(String projectName) throws IOException {
        ...
        String path = "/Users/ahmedalsayed/Documents/word2vec/apps/" + projectName;
        String dstFolder = "/Users/ahmedalsayed/Documents/word2vec/data/interfaces/";
